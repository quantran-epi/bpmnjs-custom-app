...
export const PanelHeaderProvider = {
    ...
    getDocumentationRef: (element, modeler) => {
        const elementTemplates = getTemplatesService(modeler);
    ...
    // getElementIcon: (element, modeler) => {
...
function getTemplatesService(modeler) {

    // eslint-disable-next-line react-hooks/rules-of-hooks
    return modeler.get('elementTemplates', false);
}
