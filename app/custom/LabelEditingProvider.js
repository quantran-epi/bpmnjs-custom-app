...
// function isLabelExternalExtended(semantic) {
//     return is(semantic, 'custom:CustomShape');
// }
...
LabelEditingProvider.prototype.activate = function (element) {
    ...
    if (isLabelExternal(element)
        // || isLabelExternalExtended(element)
    ) {
        assign(options, {
            autoResize: true
        });
...
LabelEditingProvider.prototype.getEditingBBox = function (element) {
    ...
    if (isAny(element, ['custom:Web', 'custom:Click']) || isAny(element, ['bpmn:Task', 'bpmn:CallActivity']) ||
    ...
    if ((isLabelExternal(target)
        // || isLabelExternalExtended(target)
    )
